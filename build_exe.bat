...
".venv\Scripts\pyinstaller.exe" --noconfirm --clean --windowed --name EcoDICOM --paths . --collect-all PySide6 --collect-all pydicom --collect-all cv2_enumerate_cameras --hidden-import app --hidden-import app.ui.main_window --hidden-import app.ui.widgets.live_preview --hidden-import app.update_check --hidden-import app.ui.widgets.studies_browser --hidden-import app.dicom.viewer --hidden-import app.ui.widgets.annotate_canvas --hidden-import app.device.enhance --hidden-import app.dicom.generator --hidden-import app.device.capture --hidden-import app.device.easycap --hidden-import app.storage.database --hidden-import cv2_enumerate_cameras main.py
echo.
if errorlevel 1 (
